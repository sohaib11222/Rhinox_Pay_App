  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Create Buy Ad</Text>
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={styles.sectionLabel}>Select crypto to Buy</Text>
          <TouchableOpacity
      ...
      >
        <View style={styles.successModalOverlay}>
          <View style={styles.successModalContent}>
            ...
            <Text style={styles.successModalTitle}>Buy Ad Created</Text>
