...
const PaymentSettings = () => {
  ...
  const rhinoxPayId = homeData?.data?.user?.rhinoxPayId || 'Generating...';
            ...
            <View style={styles.formCard}>
              ...
              {paymentMethodType === 'rhinoxpay_id' && (
                <View style={styles.formField}>
                  ...
                  <ThemedText style={[styles.inputText, { color: '#A9EF45', paddingVertical: 18 }]}>
                    {rhinoxPayId}
                  </ThemedText>
                  <ThemedText style={{ color: 'rgba(255, 255, 255, 0.5)', fontSize: 12, marginTop: 4 }}>
                    This ID is generated by Rhinox Pay and linked automatically
                  </ThemedText>
                </View>
              )}
